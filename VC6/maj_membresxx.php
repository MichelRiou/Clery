...
<body bgcolor="#FFFFFF" text=black onload="document.getElementById('RI').focus()">
        <div align="center" style="background-color:#FFFFFF">
		 <form name="formulaire" action="maj_membres.php" method="post">
                <table class="listing">
		...
		<form name="form2" action="maj3_membres.php" method="post" onSubmit="return verif_form()">
		<table class="listing">
		<caption style="background-color:#FFFFAA">CREATION</caption>
		<tr><th class="TD0"><span><input type="radio" name="pol" value="Mme" checked="checked">Mme</span>
		<span><input type="radio" name="pol" value="Mle">Mlle</span>
		<span><input type="radio" name="pol" value="Mr">Mr</span></th><th class="TD0"></th><th class="TD0"></th><th class="TD1"></th><th class="TD1"></th></tr>
		<tr><th class="TD0">Nom</th><th class="TD0">Prénom</th><th class="TD0">E-mail</th><th class="TD1">Code postal</th><th class="TD1">Taille</th></tr>
		<tr><td><input class="text" type="text" id="TI" size="25" maxlength="25"name="nom" value="<?php echo htmlspecialchars($savnom) ?>"></td>
		    <td class="TD0"><input class="text"  type="text" size="25" maxlength="25" name="prenom"></td>
			...
			<td class="TD1"><input class="text" type="text" size="5" maxlength="5"name="pos"></td>
			<td class="TD1"><input class="text" type="text" size="5" maxlength="5" name="taille"></td></td></tr>
		<tr><th class="TD0">Adresse</th><th class="TD0">Suite adresse</th><th class="TD0">Ville</th><th class="TD1">Visite</th><th class="TD1"></th></tr>
			<tr><td class="TD0"><input class="text" type="text" size="30" maxlength="30" name="ad1"></td>
		    <td class="TD0"><input class="text" type="text" size="30" maxlength="30" name="ad2"></td>
			...
			<td class="TD1"><input class="bouton1" type="submit" value="Créer"><input type="hidden" name="type" value="I"><input type="hidden" name="id" value="0"></td></tr>
     ...
     -->
		...
		{
		?>
		<tr><td class="TD0"><?php echo nl2br(htmlspecialchars(strtoupper($data['nom']))) ?></td>
