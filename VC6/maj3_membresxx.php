...
switch ($_POST['type']) {
case "M":
$result6= $db->prepare('UPDATE membres SET NOM= :QN1,PRENOM= :QN2,POLITESSE= :QN3,ADRESSE1= :QN4,ADRESSE2= :QN5,CODE_POSTAL= :QN6,VILLE= :QN7, TAILLE= :QN8,EMAIL= :QN9  WHERE ID_MEMBRE = :QN20 ');
            $result6->execute(array(':QN1'=>$_POST['nom'],':QN2'=>$_POST['prenom'],':QN3'=>$_POST['pol'],':QN4'=>$_POST['ad1'],':QN5'=>$_POST['ad2'],':QN6'=>$_POST['pos'],':QN7'=>$_POST['ville'],':QN8'=>$_POST['taille'],':QN9'=>$_POST['email'],':QN20'=>intval($_POST['id']))); /* close cursor a faire */
			$result6->closecursor();
break;
case "I":
