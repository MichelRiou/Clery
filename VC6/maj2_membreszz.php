...
function verif_mail()
    ...
    return false;
	 ...
	 <body>
		<form name="form4" action="maj3_membres.php" method="post" onSubmit="return verif_form()">
		  <center>
		...
		<tr class="TD0"><td class="TD0">ADRESSE</td><td class="TD0"><input class="text" type="text" size="30" maxlength="30" name="ad1" value="<?php echo ($data5['adresse1']) ?>"></td></tr>
		<tr class="TD0"><td class="TD0"></td><td class="TD0"><input class="text" type="text" size="30" maxlength="30" name="ad2" value="<?php echo ($data5['adresse2']) ?>"></td></tr>
